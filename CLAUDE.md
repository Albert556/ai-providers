...
This is a Rust CLI tool named `aip` (AI Providers) for managing Claude Code configuration profiles. It enables quick switching between different Claude Code configurations by providing commands to view, add, delete, edit, and switch profiles.

### Purpose
- Manage multiple Claude Code configuration profiles (~/.claude/settings.json)
...
- The tool manages configuration files for Claude Code and Codex
