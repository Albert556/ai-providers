...
- `install.sh` :: unix-installer; curl|sh; downloads binary from GitHub Releases to ~/.local/bin
- `install.ps1` :: windows-installer; irm|iex; downloads binary from GitHub Releases to %LOCALAPPDATA%\aip
